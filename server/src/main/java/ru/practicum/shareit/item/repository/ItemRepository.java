...
public interface ItemRepository extends JpaRepository<Item, Long> {
     ...
     * @return список вещей, созданных в ответ на запрос
     */
    List<Item> findByRequestOrderById(ItemRequest request);

    /**
     * Поиск вещей по списку запросов.
     *
     * @param requests список запросов вещей
     * @return список вещей, созданных в ответ на запросы
     */
    List<Item> findByRequestInOrderById(List<ItemRequest> requests);
}